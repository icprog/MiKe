...
{
    public partial class FormLEEBoard :FormBaseChild
    {
        LineProductMesBll.Bll.LEEBoardBll _bll=null;
        ...
        public FormLEEBoard ( )
        {
            ...
            _bll = new LineProductMesBll . Bll . LEEBoardBll ( );
            ...
            this . Text = this . Text + ( "(日期:" + LineProductMesBll . ObtainInfo . getDate ( "面板车间" ) + ")" );

        }

        private void FormLEEBoard_Load ( object sender ,EventArgs e )
        {
        ...
        void getData ( bool result )
        {
            if ( result )
            {
                ...
                timeChange = LineProductMesBll . ObtainInfo . getTimeChange ( "面板车间" );
                numData = LineProductMesBll . ObtainInfo . getNumData ( "面板车间" );
                result = false;
                isOk = true;
                chartHandler ( isOk );
            }
