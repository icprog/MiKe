...
{
    public partial class FormInjectionBoard :FormBaseChild
    {
        LineProductMesBll.Bll.InjectionBoardBll _bll=null;
        ...
        public FormInjectionBoard ( )
        {
            InitializeComponent ( );

            Control . CheckForIllegalCrossThreadCalls = false;

            _bll = new LineProductMesBll . Bll . InjectionBoardBll ( );
            ...
            this . Text = this . Text + ( "(日期:" + LineProductMesBll . ObtainInfo . getDate ( "注塑车间" ) + ")" );
        }

        private void FormInjectionBoard_Load ( object sender ,EventArgs e )
        {
        ...
        void getData ( bool result )
        {
            if ( result )
            {
                ...
                timeChange = LineProductMesBll . ObtainInfo . getTimeChange ( "注塑车间" );
                numData = LineProductMesBll . ObtainInfo . getNumData ( "注塑车间" );
                result = false;
                isOk = true;
                chartHandler ( isOk );
            }
