...
{
    public partial class FormHardBoard :FormBaseChild
    {

        LineProductMesBll.Bll.HardBoardBll _bll=null;
        ...
        public FormHardBoard ( )
        {
            InitializeComponent ( );

            Control . CheckForIllegalCrossThreadCalls = false;

            _bll = new LineProductMesBll . Bll . HardBoardBll ( );
            ...
            this . Text = this . Text + ( "(日期:" + LineProductMesBll . ObtainInfo . getDate ( "五金车间" ) + ")" );
            start = 0;
        }

        private void FormHardBoard_Load ( object sender ,EventArgs e )
        {
            check = "否";
        ...
        void customTime ( )
        {
            System . Timers . Timer t = new System . Timers . Timer ( 1000 * timeChange );
        ...
        void getData ( bool result )
        {
            if ( result )
            {
                ...
                timeChange = 60 * LineProductMesBll . ObtainInfo . getTimeChange ( "五金车间" );
                numData = LineProductMesBll . ObtainInfo . getNumData ( "五金车间" );
                result = false;
                isOk = true;
                chartHandler ( isOk );
            }
