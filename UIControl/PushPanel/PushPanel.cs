...
using UILibrary.PushPanel.Design;
...
namespace UILibrary.PushPanel
{
    ...
    public class PushPanel : BorderPanel, ISupportInitialize
    {
        #region Fields
        ...
        public class PushPanelItemCollection : IList, ICollection, IEnumerable
        {
            ...
            private PushPanel _owner;

            #endregion

            #region Constructors

            public PushPanelItemCollection(PushPanel owner)
            {
                _owner = owner;
            }
