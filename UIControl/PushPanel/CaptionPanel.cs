...
namespace UILibrary.PushPanel
{
    ...
    public class CaptionPanel : PanelBase
    {
        #region Fileds
        ...
        protected virtual void OnCaptionMouseMove(MouseEventArgs e)
        {
            ...
            System.Diagnostics.Trace.WriteLine("Move: " + CaptionState.ToString());
        }
        ...
        protected virtual void OnCaptionMouseDown(MouseEventArgs e)
        {
            ...
            System.Diagnostics.Trace.WriteLine("Down: " + CaptionState.ToString());
        }
        ...
        protected virtual void OnCaptionMouseClick(MouseEventArgs e)
        {
            ...
            System.Diagnostics.Trace.WriteLine("Click: " + CaptionState.ToString());
        }
        ...
        protected virtual void OnCaptionMouseEnter(EventArgs e)
        {
            ...
            System.Diagnostics.Trace.WriteLine("Enter: " + CaptionState.ToString());
        }
        ...
        protected virtual void OnCaptionMouseLeave(EventArgs e)
        {
            ...
            System.Diagnostics.Trace.WriteLine("Leave: " + CaptionState.ToString());
        }
